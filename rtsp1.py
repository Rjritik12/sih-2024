...
def start_rtsp_stream(rtsp_link):
    # Initialize the RTSP video stream
    stream = cv2.VideoCapture(rtsp_link)
...
if __name__ == "__main__":
    rtsp_link = input("Enter RTSP link: ")
    start_rtsp_stream(rtsp_link)